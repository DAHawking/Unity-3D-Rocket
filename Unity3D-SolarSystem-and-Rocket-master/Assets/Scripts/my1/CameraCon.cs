...
public class CameraCon : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            targetPosition -= transform.up * keymoveSpeed / (2f * default_distance);
        }
        ...
        {
            targetPosition += transform.forward * keymoveSpeed / (2f * default_distance);
        }
        // 后退
        ...
        {
            targetPosition += transform.right * keymoveSpeed / (2f * default_distance);
        }
